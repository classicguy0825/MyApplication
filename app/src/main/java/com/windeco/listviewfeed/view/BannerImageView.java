...
public class BannerImageView extends ImageView {
	...
	public void setImageUrl(String url, ImageLoader imageLoader) {
		...
		//Log.d("로그", "BannerImageView's mUrl :" + mUrl);
	}
	...
	private void loadImageIfNecessary(final boolean isInLayoutPass) {
		...
		//Log.d("로그", "loadImageIfNecessary's height :" + height);
		...
		Log.d("로그", "# BannerImageView getWidth / getHeight() : " + getWidth() + " / " + getHeight());

		if (width == 0 && height == 0 && !isFullyWrapContent) {
			Log.d("로그", "# BannerImageView isFullyWrapContent : " + isFullyWrapContent);
			return;
		}
		...
		ImageContainer newContainer = mImageLoader.get(mUrl, new ImageListener() {
					...
					public void onResponse(final ImageContainer response, boolean isImmediate) {
						...
						if (response.getBitmap() != null) {
							...
							//Log.d("로그", " BannerImageView's getBitmap : "+ response.getBitmap());
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		Log.d("로그", "BannerImageView's onLayout");
